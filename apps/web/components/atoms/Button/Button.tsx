...
const buttonStyles = cva(
	cn(
		...
		"h-9 w-fit gap-2 px-2 border-0 rounded-(--border-radius)",
		"text-(--font-size-medium) transition-[background-color] duration-100 ease-in-out",
		"text-(--color-text) dark:text-white",
